  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1600px] px-5 py-24 sm:px-8 md:py-32 lg:px-12">
        ...
        {/* Editorial masonry — varied aspects and offsets, never six equal cards */}
        <div className="mt-16 columns-1 gap-10 sm:columns-2 lg:columns-3 lg:gap-12">
          {work.items.map((item, i) => (
            <WhatsAppLink
              ...
              className={`group mb-14 block break-inside-avoid ${capable ? 'cursor-none' : ''} ${OFFSETS[i] ?? ''}`}
            >
              <div className="overflow-hidden">
                <PlaceholderImage
                  ...
                  className="w-full"
                  imgClassName="transition-transform duration-[1200ms] ease-editorial group-hover:scale-[1.04]"
                />
              </div>
